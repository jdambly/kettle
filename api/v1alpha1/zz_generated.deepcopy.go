...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AllocatedIPkey) DeepCopyInto(out *AllocatedIPkey) {
	{
		in := &in
		*out = make(AllocatedIPkey, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatedIPkey.
func (in AllocatedIPkey) DeepCopy() AllocatedIPkey {
	if in == nil {
		return nil
	}
	out := new(AllocatedIPkey)
	in.DeepCopyInto(out)
	return *out
}
