...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AllocatedIPMap) DeepCopyInto(out *AllocatedIPMap) {
	{
		in := &in
		*out = make(AllocatedIPMap, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatedIPMap.
func (in AllocatedIPMap) DeepCopy() AllocatedIPMap {
	if in == nil {
		return nil
	}
	out := new(AllocatedIPMap)
	in.DeepCopyInto(out)
	return *out
}
